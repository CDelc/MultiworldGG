...
- [Universal Tracker](https://github.com/FarisTheAncient/Archipelago/releases?q=Tracker&expanded=true) for an updating list of available checks (installed with MWGG)
...
After the host has generated the seed and has given you the connection information you can use the `MultiworldGG Launcher` 
...
If you are playing this mod and are encountering bugs **DO NOT** report them to the MultiworldGG server this is not 
