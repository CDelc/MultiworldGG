...
Make sure you are using the KH1 Client and not the Text Client. You will need to open the client via the MultiworldGG Launcher.
...
Make sure you are using the correct seed zip and mod for your MultiworldGG game.<br>
